...
class _ProfileScreenState extends State<ProfileScreen> {
  Widget _userInformationLoader({
    ...
    if (userData != null) {
      return Text(property, style: withStyle ? Theme
          .of(context)
          .textTheme
          .titleLarge
          ?.copyWith(fontSize: 15, fontWeight: FontWeight.normal) : null,);
    } else {
      return Container(
        height: heigth ?? 20,
        width: width ?? 80,
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, WidgetRef ref, child) {
      ...
      final UserModel? userData = userRepository.user;
